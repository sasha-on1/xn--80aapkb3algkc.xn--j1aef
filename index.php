...
<body>
  ...
  <div class="wrapper">
          ...
          <ul class="navbar-nav">
            ...
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                ...
                <a class="dropdown-item btn" href="?teach=<start.php?=$teach['id_t']?>">
                  <?=$teach['name_t']?></a>
                <?php endforeach; ?>
                <?php endif; ?>
              </div>
    ...
    <div class="groups">
      <div class="container">
        <div class="card__title"><h6 class="title">Все группы</h6></div>
        <div class="card">  
          <?php if( $groups ): ?>
          <?php foreach ($groups as $group): ?>
          <div class="card__content"><a class="content" href="start.php?group=<?=$group['id_g']?>"><?=$group['name_g']?></a></div>
          <?php endforeach; ?>
          <?php endif; ?>
        </div>
      </div>
