<?php
  ...
  // Список замен для групп + группы из замен
  $replacemants=get_repl();
  $group_repl=get_grepl();
...
<body>
  ...
  <div class="wrapper">
    ...
    <div class="container">
      <?php if( $group_repl ): ?>
      <?php foreach ( $group_repl as $gr ): ?>
        <div class="card">
          <div class="card__title"><h6 class="title"><?= $gr['name_g']; ?></h6></div>
          <?php if( $replacemants ): ?>
          <?php foreach( $replacemants as $repl ): ?>
          <?php if( $repl['name_g'] == $gr['name_g'] ): ?>
          <div class="card__content"><a class="content"><?=$repl['name_l'];?></a></div>
          <?php endif; ?>
          <?php endforeach; ?>
          <?php endif; ?>
        </div>
